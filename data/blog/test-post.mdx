...
- [Pre Recs](/blog/test-post#pre-reqs)

- [Creating a Firebase Project](/blog/test-post#creating-a-firebase-project)

- [Add Firebase to Android](/blog/test-post#add-firebase-to-android)

- [Add Firebase to IOS](/blog/test-post#add-firebase-to-ios)

- [Finishing Up](/blog/test-post#finishing-up)
...
<ProsCard title="testing" pros={['testing', 'testing 2']} />

<ConsCard title="just testing" cons={['just testing', 'just testing 2']} />
