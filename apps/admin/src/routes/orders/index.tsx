...
// FIX ADM-03: status badge variants
...
// FIX ADM-03: server-side pagination for orders list.
// Previously the page loaded all orders with no pagination — this caused
// the response payload to grow unboundedly as order volume increased,
// degrading load time and potentially crashing low-memory browsers.
function OrdersPage() {
